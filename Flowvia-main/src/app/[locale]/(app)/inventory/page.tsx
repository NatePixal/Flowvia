...
import ProductBarcodeDialog from '@/components/barcode/product-barcode-dialog';
...
export default function InventoryPage() {
  ...
  return (
    <>
                          ...
                          <TableRow key={product.id}>
                            ...
                            <TableCell className="text-center">
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  <DropdownMenuItem onClick={() => openBarcodeDialog(product)}>{t('barcode.show')}</DropdownMenuItem>
      ...
      <ProductBarcodeDialog open={isBarcodeDialogOpen} onOpenChange={setIsBarcodeDialogOpen} product={selectedProduct} />
    </>
  );
}
