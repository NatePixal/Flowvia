...
export function FirebaseProvider({
  ...
  const locationsEnabled = !!company?.locationsEnabled;
  const posEnabled = company?.posEnabled !== false;
  const telegramAlertsEnabled = !!company?.telegramAlertsEnabled;
  const telegramChatId = (company?.telegramChatId as any) ?? null;
  ...
  const value = useMemo(
    ...
    [
      user, userProfile, companyBaseCurrency, company, locationsEnabled, posEnabled, telegramAlertsEnabled, telegramChatId, isUserLoading, authResolved, sessionReady, companyId, role,
