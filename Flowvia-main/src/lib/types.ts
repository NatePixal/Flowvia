...
export type Company = {
  ...
  // Optional Telegram alerts settings
...
export type Product = {
  ...
  productCode: string;
  barcode?: string; // optional, defaults to productCode
...
export type Sale = {
  ...
  // Optional totals (minor units)
  discountMinor?: number;
  vatMinor?: number;
  totalMinor?: number;
  totalBaseMinor?: number;

  // FIFO consumption snapshot for refunds/exchanges
  fifo?: any;
  isDeleted?: boolean;
