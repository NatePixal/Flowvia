...
async function exportStockReportExcel(input) {
    ...
    for (const d of incAllSnap.docs) {
        ...
        const ms = anyToMillis((_c = x.incomeDate) !== null && _c !== void 0 ? _c : x.date);
        if (ms != null) {
    ...
    const rows = Array.from(agg.values()).map(a => {
        ...
        return {
            code: a.productCode,
            name: (_g = productDoc === null || productDoc === void 0 ? void 0 : productDoc.name) !== null && _g !== void 0 ? _g : "",
            opening,
    ...
    for (const d of daily) {
        ...
        (0, exportUtils_1.styleTableBodyRow)(ws3, r3, 2, 7);
