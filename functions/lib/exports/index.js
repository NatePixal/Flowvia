...
exports.exportStatement = functions
    ...
    try {
        ...
        if (statementType === 'client') {
            ...
            buf = await (0, statement_engine_1.buildStatementWorkbook)({ statementType, summary, rows, baseCurrency, locale });
        ...
        if (statementType === 'productMovement') {
            ...
            buf = await (0, statement_engine_1.buildStatementWorkbook)({ statementType, summary, rows, baseCurrency: summary.baseCurrency, locale });
