...
exports.exportStatement = functions
    ...
    try {
        ...
        if (statementType === 'client') {
            ...
            buf = await (0, statement_engine_1.buildStatementWorkbook)({ statementType: 'client', summary, rows, baseCurrency, locale });
        ...
        if (statementType === 'supplier') {
            ...
            buf = await (0, statement_engine_1.buildStatementWorkbook)({ statementType: 'supplier', summary, rows, baseCurrency, locale });
        ...
        if (statementType === 'expenses') {
            ...
            buf = await (0, statement_engine_1.buildStatementWorkbook)({ statementType: 'expenses', summary, rows, baseCurrency, locale });
