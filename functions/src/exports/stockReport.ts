...
export async function exportStockReportExcel(input: ExportStockInput): Promise<Buffer> {
  ...
  styleTitle(ws, t(locale, 'title_summary'), "FlowVia Business Solutions");
  ...
  styleTitle(ws2, t(locale, 'title_demand'), "FlowVia Business Solutions");
  ...
  styleTitle(ws3, t(locale, 'title_daily'), "FlowVia Business Solutions");
