                      ...
                      <div className="col-span-9 space-y-4">
                        ...
                        <div className="bg-charcoal/50 rounded-xl border border-white/5 p-4 h-48">
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center gap-3"><div className="size-6 bg-slate-800 rounded"></div><div className="flex-1 h-2 bg-slate-800/50 rounded"></div><div className="w-12 h-2 bg-slate-800/50 rounded"></div></div>
                            <div className="flex items-center gap-3"><div className="size-6 bg-slate-800 rounded"></div><div className="flex-1 h-2 bg-slate-800/50 rounded"></div><div className="w-12 h-2 bg-slate-800/50 rounded"></div></div>
                            <div className="flex items-center gap-3"><div className="size-6 bg-slate-800 rounded"></div><div className="flex-1 h-2 bg-slate-800/50 rounded"></div><div className="w-12 h-2 bg-slate-800/50 rounded"></div></div>
                          </div>
                        </div>
